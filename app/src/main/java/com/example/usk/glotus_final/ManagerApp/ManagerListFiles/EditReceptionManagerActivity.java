...
public class EditReceptionManagerActivity extends AppCompatActivity {
    ...
    public void findView(){
        ...
        autoComplete_zakazchik=findViewById(R.id.mactv_z_zakazchik);
        ...
        autoComplete_otkuda=findViewById(R.id.mactv_otkuda);
        autoComplete_kuda=findViewById(R.id.mactv_kuda);
